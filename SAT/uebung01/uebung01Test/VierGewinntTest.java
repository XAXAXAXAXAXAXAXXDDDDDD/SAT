...
public class VierGewinntTest extends TestCase {
    ...
    public void testCharInput() throws Exception {
    	assertOutcome("Feld existriert nicht", 8, 7, 'c', 'd', 5,4,3,3,4,2,2,2,2,1,3);
    }

    private void assertOutcome(String expectedOutcome, int width, int height, int... choices) {
        final InputStream in = getInputStreamFromChoices(width, height, choices);
    ...
    private InputStream getInputStreamFromChoices(int width, int height, int... choices) {
